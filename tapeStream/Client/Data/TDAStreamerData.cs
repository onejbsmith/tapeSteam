...
namespace tapeStream.Client.Data
{
    ...
    public class TDAStreamerData
    {
        ...
        public static async Task captureTdaServiceData(string svcFieldedJson, int moduloPrints)
        {
            ...
            foreach (var contentObj in contents)
            {
                ...
                switch (svcName)
                {
                    case "TIMESALE_EQUITY":
                        Decode_TimeSales(svcName, content, moduloPrints, symbol);
                        break;
                    case "QUOTE":
        ...
        public static void Decode_Actives(string content)
        {
            ////var words =
        ...
        public static void Decode_Book(string content)
        {
        ...
        public static void Decode_Chart(string content, string symbol)
        {
        ...
        public static void Decode_TimeSales(string svcName, string content, int moduloPrints = 2, string symbol = "QQQ")
        {
            ...
            var bids = dictQuotes.Where(t => t.Key < timeOfTimeAndSales && t.Value.bidPrice != 0);
            var asks = dictQuotes.Where(t => t.Key < timeOfTimeAndSales && t.Value.askPrice != 0);
            ...
            {
                timeAndSales.bid = bids.Last().Value.bidPrice;
                timeAndSales.ask = asks.Last().Value.askPrice;
                ...
                if (TDAStreamerData.timeSales[symbol].Count() % moduloPrints == 0)
        ...
        public static void getBookColumnsData(ref BookDataItem[] asksData, ref BookDataItem[] bidsData, int seconds, bool isPrintsSize, string symbol)
        {
        ...
        public static DataItem[] getPrintsData(string symbol, int seconds)
        {
            ...
            printsData[0].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 1 && t.time >= thisManySecondsAgo).Sum(t => t.size);
            printsData[1].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 2 && t.time >= thisManySecondsAgo).Sum(t => t.size);
            printsData[2].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 3 && t.time >= thisManySecondsAgo).Sum(t => t.size);
            printsData[3].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 4 && t.time >= thisManySecondsAgo).Sum(t => t.size);
            printsData[4].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 5 && t.time >= thisManySecondsAgo).Sum(t => t.size);
            return printsData;
        ...
        public static void getPrintsData(ref DataItem[] printsData, int seconds, bool isPrintsSize, string symbol)
        {
            ...
            else // prints within the last n seconds
            {
                ...
                {
                    printsData[0].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 1 && t.time >= thisManySecondsAgo).Count();
                    printsData[1].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 2 && t.time >= thisManySecondsAgo).Count();
                    printsData[2].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 3 && t.time >= thisManySecondsAgo).Count();
                    printsData[3].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 4 && t.time >= thisManySecondsAgo).Count();
                    printsData[4].Revenue = TDAStreamerData.timeSales[symbol].Where(t => t.level == 5 && t.time >= thisManySecondsAgo).Count();
                }
