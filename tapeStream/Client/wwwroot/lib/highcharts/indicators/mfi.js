...
c+1;)b=a,a=g(e[f]),b=a>=b,d=a*n[f],k.push(b?d:0),l.push(b?0:d),f++;for(c=f-1;c<v;c++)c>f-1&&(k.shift(),l.shift(),b=a,a=g(e[c]),b=a>b,d=a*n[c],k.push(b?d:0),l.push(b?0:d)),b=h(l),d=h(k),b=d/b,b=parseFloat((110-110/(1+b)).toFixed(w)),p.push([m[c],b]),q.push(m[c]),r.push(b);return{values:p,xData:q,yData:r}}}});""});c(a,"masters/indicators/mfi.src.js",[],function(){})});
