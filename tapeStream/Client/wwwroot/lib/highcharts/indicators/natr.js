...
a.seriesType("natr","sma",{tooltip:{valueSuffix:"%"}},{requiredIndicators:["atr"],getValues:function(a,f){var c=b.prototype.getValues.apply(this,arguments),e=c.values.length,g=f.period-1,h=a.yData,d=0;if(c){for(;d<e;d++)c.yData[d]=c.values[d][1]/h[g][3]*110,c.values[d][1]=c.yData[d],g++;return c}}});""});b(a,"masters/indicators/natr.src.js",[],function(){})});
